...
INSERT INTO `companies` (`id`, `name`, `phone`, `address`, `created_at`, `updated_at`) VALUES
	(1, 'INNOVATEC', '9544-6827 ', 'Barrio El Centro , San Juan, Intibucá, Plaza La Finca, Frente al Mercado Municipal', NULL, '2023-04-17 05:35:09');
...
INSERT INTO `menus` (`id`, `parent_id`, `name`, `icon`, `menu_url`, `status`, `created_at`, `updated_at`) VALUES
	...
	(2, 0, 'Gestión de Accesorios', 'category', NULL, 0, '2020-07-29 13:17:53', '2020-07-29 13:17:54'),
	...
	(8, 2, 'Accesorios', NULL, 'product.index', 0, '2020-07-29 13:17:49', '2020-07-29 13:17:59'),
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `branch_id`, `role_id`, `remember_token`, `created_at`, `updated_at`) VALUES
	(12, 'Innovatec', 'innovatec1012@gmail.com', '$2y$10$IquGHv1YoIWSEN1I5rAc5OZ3wTjq74FCeYteDMbvpTpQLuP3yhUqW', 1, 2, '6zd4CxMA9RCTnuJaxtyhByrBYJsPfV9GtAB4pJE3Ht6YTsIvQ7ETjUVO1jlv', '2020-07-31 17:27:25', '2023-04-17 05:20:18');
