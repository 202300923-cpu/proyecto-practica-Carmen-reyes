...
//Reparaciones
Route::get('/reparaciones', 'ReparacionController@index');
Route::get('/reparaciones/list', 'ReparacionController@show');
Route::post('/reparaciones/store', 'ReparacionController@store');
Route::delete('/reparaciones/delete/{id}', 'ReparacionController@destroy');
Route::post('/reparaciones/estado','ReparacionController@estado');
